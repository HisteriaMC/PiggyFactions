...
use minicore\libs\Commando\args\TextArgument;
...
class CreateSubCommand extends FactionSubCommand
{
    ...
    public function onNormalRun(Player $sender, ?Faction $faction, FactionsPlayer $member, string $aliasUsed, array $args): void
    {
        ...
        if ($this->plugin->getConfig()->getNested("factions.enforce-alphanumeric-names", false) && !ctype_alnum(str_replace(["-", "_"], "", $factionName))) {
